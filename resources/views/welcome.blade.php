...
@dump($portfolios)
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="item">
                <img class="img-responsive" src="{{ asset('img/1920x1080/02.jpg') }}" alt="Slider Image">
                <div class="container">
                    <div class="carousel-centered">
                        <div class="margin-b-40">
            ...
            <div class="masonry-grid row">
                ...
                <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4 sm-margin-b-30">
                    <div class="margin-b-60">
                        <h2>Berpengalaman</h2>
                        <p>Tim kami memiliki pengalaman bertahun-tahun dalam menangani berbagai permasalahan IT, memastikan solusi tepat, cepat, dan sesuai kebutuhan Anda.</p>
                    </div>
                ...
                <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4 sm-margin-b-30">
                    <div class="margin-b-60">
                        <h2>Konsultasi Harga</h2>
                        <p>Kami menyediakan layanan dengan harga yang fleksibel, disesuaikan dengan kebutuhan unik setiap klien tanpa mengorbankan kualitas dan hasil kerja.</p>  
                    </div>
                ...
                <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4">
                    <div class="margin-b-60">
                        <h2>Monitoring</h2>
                        <p>Layanan kami menjaga sistem dan infrastruktur IT perusahaan Anda tetap optimal, memastikan kelancaran operasional setiap saat tanpa gangguan.</p>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-5 col-sm-5 md-margin-b-60">
                        <div class="margin-t-50 margin-b-30">
                            <h2>Why Us?</h2>
                            <p>Memilih IT Support yang kompeten berarti memastikan setiap aspek teknologi perusahaan Anda berjalan lancar, aman, dan efisien. Dengan dukungan profesional, masalah dapat diatasi sebelum mengganggu operasional, sistem tetap terpantau 24/7, dan infrastruktur selalu diperbarui sesuai kebutuhan bisnis. Kami hadir untuk menjadi mitra yang membantu Anda fokus pada pertumbuhan perusahaan, sementara urusan teknis kami tangani sepenuhnya.</p>
                        </div>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                        <div class="panel-body">
                                            Kami selalu mengikuti perkembangan teknologi terkini, memastikan setiap solusi yang kami berikan relevan, efisien, dan siap menghadapi tantangan masa depan.
                                        </div>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="headingTwo">
                                        <h4 class="panel-title">
                                            <a class="collapsed panel-title-child" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                Dukungan Pelanggan Ramah
                                            </a>
                                        </h4>
                                    </div>
                                    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                        <div class="panel-body">
                                            Tim support kami tidak hanya ahli di bidang teknis, tetapi juga ramah dan komunikatif, membuat Anda nyaman berinteraksi saat membutuhkan bantuan.
                                        </div>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                                        <div class="panel-body">
                                            Kami menerapkan standar keamanan tinggi untuk melindungi data dan informasi sensitif, sehingga Anda bisa fokus pada perkembangan bisnis tanpa khawatir.
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- Latest Products -->
    {{-- <div id="products" class="bg-color-sky-light">
        <div class="content-lg container section-seperator">
    ...
    <!-- Work -->
    <div class="bg-color-sky-light" id="work">
    ...
    <!-- Contact -->
    <div id="contact" class="bg-color-sky-light">
        <!-- Contact List -->
        <div class="section-seperator">
            <div class="content-lg container">
                <div class="row">
                    <!-- Contact List -->
                    <div class="col-sm-4 sm-margin-b-50">
                        <h3><a href="">Zurich</a> <span class="text-uppercase margin-l-20">Human Resources</span></h3>
                        <p>Lorem ipsum dolor sit amet consectetur adipiscing elit sed tempor incdidunt ut laboret dolor magna ut consequat siad esqudiat dolor</p>
                    ...
                    <!-- Contact List -->
                    <div class="col-sm-4 sm-margin-b-50">
                        <h3><a href="">Malta</a> <span class="text-uppercase margin-l-20">Development</span></h3>
                        <p>Lorem ipsum dolor sit amet consectetur adipiscing elit sed tempor incdidunt ut laboret dolor magna ut consequat siad esqudiat dolor</p>
                        <ul class="list-unstyled contact-list">
                    ...
                    <!-- Contact List -->
                    <div class="col-sm-4 sm-margin-b-50">
                        <h3><a href="">Manchester</a> <span class="text-uppercase margin-l-20">CEO</span></h3>
                        <p>Lorem ipsum dolor sit amet consectetur adipiscing elit sed tempor incdidunt ut laboret dolor magna ut consequat siad esqudiat dolor</p>
                        <ul class="list-unstyled contact-list">
